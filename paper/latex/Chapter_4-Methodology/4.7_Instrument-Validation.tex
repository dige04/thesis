...
Section~\ref{sec:instrument-results}; the amended gate's GO verdict is what clears the full
144-run matrix to proceed on the fixed code at the frozen experiment commit \texttt{cceb325}
(the rerun and its results are reported in Chapter~\ref{ch:results}).
