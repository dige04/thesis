...
\emph{before} the full matrix was run, and unlike the H1--H5 contrasts these numbers do not
depend on the trustworthy rerun --- they are reported here as a durable methodological
result.
...
\begin{table}[htbp]
  \centering
  \caption{Amended instrument-health gate on fresh post-hotfix data
  (\texttt{results/ab\_gate/amended\_cceb325\_result.json}). Instrument-attributable
